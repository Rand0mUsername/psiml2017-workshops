...
class WGAN:
    ...
    def __init__(self,
        ...
        critic_real = self.critic(self.real_image)
        critic_fake = self.critic(self.fake_image, reuse=True)

        self.g_cost = tf.reduce_mean(critic_fake)
        self.c_cost = tf.reduce_mean(critic_real - critic_fake)
        ...
        self.g_optimizer = self.optimizer.minimize(self.g_cost, var_list=g_vars, name='GeneratorOptimizer')
        self.c_optimizer = self.optimizer.minimize(self.c_cost, var_list=c_vars, name='CriticOptimizer')
